...
#endif
#ifdef GENERATOR_FILE
extern int riscv_fli_value_by_int;
#else
  int x_riscv_fli_value_by_int;
#define riscv_fli_value_by_int global_options.x_riscv_fli_value_by_int
#endif
#ifdef GENERATOR_FILE
...
#define MASK_RVZFA (1U << 15)
#define MASK_RVZFH (1U << 16)
#define MASK_VECTOR (1U << 17)
#define MASK_XTHEAD (1U << 18)
#define MASK_XTHEAD_C (1U << 19)
#define MASK_XTHEAD_E (1U << 20)
#define MASK_XTHEAD_SE (1U << 21)
#define MASK_XTHEAD_V (1U << 22)
#define MASK_ZFBFMIN (1U << 23)
#define MASK_ZPN (1U << 24)
#define MASK_ZPRVSFEXTRA (1U << 25)
#define MASK_ZPSFOPERAND (1U << 26)
#define MASK_ZVFBFMIN (1U << 27)
#define MASK_ZVFBFWMA (1U << 28)
...
#define TARGET_RVZFA ((target_flags & MASK_RVZFA) != 0)
...
#define TARGET_ZFBFMIN ((target_flags & MASK_ZFBFMIN) != 0)
...
#define TARGET_ZVFBFMIN ((target_flags & MASK_ZVFBFMIN) != 0)
#define TARGET_ZVFBFWMA ((target_flags & MASK_ZVFBFWMA) != 0)
...
enum opt_code
{
  ...
  OPT_minline_atomics = 1631,                /* -minline-atomics */
  OPT_minvariant_as_constant = 1632,         /* -minvariant-as-constant */
  OPT_mipa_unhot_inline = 1633,              /* -mipa-unhot-inline */
  OPT_mipush = 1634,                         /* -mipush */
  OPT_misa_spec_ = 1635,                     /* -misa-spec= */
  OPT_miv_adjust_addr_cost = 1636,           /* -miv-adjust-addr-cost */
  OPT_mlcm_mcfg = 1637,                      /* -mlcm-mcfg */
  OPT_mldd = 1638,                           /* -mldd */
  OPT_mldi = 1639,                           /* -mldi */
  OPT_mldr = 1640,                           /* -mldr */
  OPT_mload_merging = 1641,                  /* -mload-merging */
  OPT_mmove_loop_vsetvl = 1642,              /* -mmove-loop-vsetvl */
  OPT_mmula = 1643,                          /* -mmula */
  OPT_mplt = 1644,                           /* -mplt */
  OPT_mpreferred_stack_boundary_ = 1645,     /* -mpreferred-stack-boundary= */
  OPT_mrelax = 1646,                         /* -mrelax */
  OPT_mrev = 1647,                           /* -mrev */
  OPT_mrevw = 1648,                          /* -mrevw */
  OPT_mriscv_attribute = 1649,               /* -mriscv-attribute */
  OPT_mriscv_fli_value_by_int = 1650,        /* -mriscv_fli_value_by_int */
  OPT_mrnreg_delete_noop_move = 1651,        /* -mrnreg-delete-noop-move */
  OPT_mrvv_vector_bits_ = 1652,              /* -mrvv-vector-bits= */
  OPT_msave_restore = 1653,                  /* -msave-restore */
  OPT_mshorten_memrefs = 1654,               /* -mshorten-memrefs */
  OPT_msignedness_cmpiv = 1655,              /* -msignedness-cmpiv */
  OPT_msmall_data_limit_ = 1656,             /* -msmall-data-limit= */
  OPT_msrri = 1657,                          /* -msrri */
  OPT_msrriw = 1658,                         /* -msrriw */
  OPT_mstrict_align = 1659,                  /* -mstrict-align */
  OPT_mthread_jumps1 = 1660,                 /* -mthread-jumps1 */
  OPT_mtune_ = 1661,                         /* -mtune= */
  OPT_munaligned_libcall = 1662,             /* -munaligned-libcall */
  OPT_mxor_combine = 1663,                   /* -mxor-combine */
  OPT_n = 1664,                              /* -n */
  OPT_name_sort = 1665,                      /* -name-sort */
  OPT_no_canonical_prefixes = 1666,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1667,              /* -no-integrated-cpp */
  OPT_no_pie = 1668,                         /* -no-pie */
  OPT_nocpp = 1669,                          /* -nocpp */
  OPT_nodefaultlibs = 1670,                  /* -nodefaultlibs */
  OPT_nolibc = 1671,                         /* -nolibc */
  OPT_nophoboslib = 1672,                    /* -nophoboslib */
  OPT_nostartfiles = 1673,                   /* -nostartfiles */
  OPT_nostdinc = 1674,                       /* -nostdinc */
  OPT_nostdinc__ = 1675,                     /* -nostdinc++ */
  OPT_nostdlib = 1676,                       /* -nostdlib */
  OPT_o = 1677,                              /* -o */
  OPT_objects = 1678,                        /* -objects */
  OPT_p = 1679,                              /* -p */
  OPT_pass_exit_codes = 1680,                /* -pass-exit-codes */
  /* OPT_pedantic = 1681, */                 /* -pedantic */
  OPT_pedantic_errors = 1682,                /* -pedantic-errors */
  OPT_pg = 1683,                             /* -pg */
  OPT_pie = 1684,                            /* -pie */
  OPT_pipe = 1685,                           /* -pipe */
  OPT_print_file_name_ = 1686,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1687,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1688,          /* -print-multi-directory */
  OPT_print_multi_lib = 1689,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1690,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1691,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1692,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1693,               /* -print-prog-name= */
  OPT_print_search_dirs = 1694,              /* -print-search-dirs */
  OPT_print_sysroot = 1695,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1696,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1697,                    /* -print-value */
  ...
  OPT_std_c__23 = 1733,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1734, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1735, */                /* -std=c++2b */
  OPT_std_c__98 = 1736,                      /* -std=c++98 */
  OPT_std_c11 = 1737,                        /* -std=c11 */
  OPT_std_c17 = 1738,                        /* -std=c17 */
  /* OPT_std_c18 = 1739, */                  /* -std=c18 */
  /* OPT_std_c1x = 1740, */                  /* -std=c1x */
  OPT_std_c2x = 1741,                        /* -std=c2x */
  /* OPT_std_c89 = 1742, */                  /* -std=c89 */
  OPT_std_c90 = 1743,                        /* -std=c90 */
  OPT_std_c99 = 1744,                        /* -std=c99 */
  /* OPT_std_c9x = 1745, */                  /* -std=c9x */
  OPT_std_f2003 = 1746,                      /* -std=f2003 */
  OPT_std_f2008 = 1747,                      /* -std=f2008 */
  OPT_std_f2008ts = 1748,                    /* -std=f2008ts */
  OPT_std_f2018 = 1749,                      /* -std=f2018 */
  OPT_std_f95 = 1750,                        /* -std=f95 */
  OPT_std_gnu = 1751,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1752, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1753, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1754,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1755,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 1756,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1757, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 1758, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 1759,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 1760,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 1761, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 1762, */              /* -std=gnu++2b */
